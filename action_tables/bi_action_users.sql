...
action_users AS (
    ...
    FROM (
        ...
        INNER JOIN ddxfitness_prod_v2.pg_user_payment_plans AS upp ON upp.id = t.user_payment_plan_id
        ...
        LEFT JOIN ddxfitness_prod_v2.pg_users AS us ON t.user_id = us.id
