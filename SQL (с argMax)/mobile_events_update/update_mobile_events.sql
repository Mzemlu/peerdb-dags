...
WITH
    ...
    dedup_users AS (
        SELECT
            ...
            argMax(home_club_id, _peerdb_version) AS home_club_id
    ...
    mobile_users AS (
        SELECT
            ...
            mp.end_date
        FROM users_list ul
        LEFT JOIN dedup_users u ON ul.user_id = u.id
...
LEFT JOIN dedup_user_payment_plans upp ON mug.user_payment_plan_id = upp.id
